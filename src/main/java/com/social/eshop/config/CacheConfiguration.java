...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.social.eshop.domain.Manager.class.getName() + ".roles", jcacheConfiguration);
            ...
            cm.createCache(com.social.eshop.domain.Roles.class.getName(), jcacheConfiguration);
